...
(() => {
        ...
        const colors = ["bg-gray-800", "bg-yellow-300", "bg-yellow-100", "bg-red-800", "bg-gray-900", "bg-red-600", "bg-green-600", "bg-green-900", "bg-green-800", "bg-blue-500", "bg-blue-700"];
        ...
        function gamereset() {
            ...
            for (i = 0; i < sh; i++) {
                for (j = 0; j < sw; j++) {
                    document.getElementsByClassName('cell')[i * sw + j].classList.remove("bg-gray-800", "bg-green-600", "bg-green-900", "bg-green-800", "bg-yellow-300", "bg-yellow-100", "bg-red-800", "bg-gray-900", "bg-red-600", "bg-blue-500", "bg-blue-700");
        ...
        async function gamestart() {
            ...
            for (i = 0; i < playerx; i++) {
                document.getElementsByClassName('cell')[playery * sw + i].classList.remove("bg-gray-800", "bg-yellow-300", "bg-yellow-100", "bg-green-600", "bg-green-900", "bg-green-800", "bg-gray-900", "bg-red-800", "bg-red-600", "bg-blue-500", "bg-blue-700");
        ...
        async function enemycycle(pattern, speed, style, trace, x, y, dir, currentgame, prevxshift) {
            if (currentgame == restarts) {
                ...
                if (document.getElementsByClassName('cell')[y * sw + x].classList.contains("bg-yellow-300") == true) {
                    dead = 1;
                    document.getElementsByClassName('cell')[y * sw + x].classList.remove("bg-gray-800", "bg-yellow-300", "bg-yellow-100", "bg-green-600", "bg-green-900", "bg-green-800", "bg-gray-900", "bg-red-800", "bg-red-600", "bg-blue-500", "bg-blue-700")
                    document.getElementsByClassName('cell')[y * sw + x].classList.add("bg-yellow-300")
                };
                if (dead == 0) {
                    //clear previous position if it was in the view
                    if (x - relshift < sw) {
                        document.getElementsByClassName('cell')[y * sw + x - relshift].classList.remove("bg-gray-800", "bg-yellow-300", "bg-yellow-100", "bg-green-600", "bg-green-900", "bg-green-800", "bg-gray-900", "bg-red-800", "bg-red-600", "bg-blue-500", "bg-blue-700")
                    ...
                    //draws itself, then kills itself after one 'cycle'
                ...
                //leaves a deadly snail-like trail
    ...
    function updatepos() {
        if (playerx != oldplayerx || playery != oldplayery) {
            ...
            document.getElementsByClassName('cell')[oldplayery * sw + oldplayerx].classList.remove("bg-gray-800", "bg-yellow-300", "bg-green-600", "bg-green-900", "bg-green-800", "bg-gray-900", "bg-yellow-100", "bg-red-800", "bg-red-600", "bg-blue-500", "bg-blue-700");
                ...
                for (i = 0; i < sh; i++) {
                    for (j = 0; j < sw; j++) {
                        if (j < (sw - 1)) {
                            ...
                            document.getElementsByClassName('cell')[i * sw + j].classList.remove("bg-gray-800", "bg-green-600", "bg-green-900", "bg-green-800", "bg-yellow-300", "bg-gray-900", "bg-yellow-100", "bg-red-800", "bg-red-600", "bg-blue-500", "bg-blue-700")
