...
>>>>>>> 9c96dc4ac74660254fc4efa2b5bbfc8468bdbd96
...
rockarray = [
  "it's a tie",
  "Your rock is wrapped in paper",
  "Your rock smashes the scissors",
  "Your rock squashes the lizard to a pulp.",
  "Your rock is vaporized by Spock.",
];
paperarray = [
  "Your paper covers the rock",
  "it's a tie",
  " Your paper refutes the spock",
  "Your paper is cut by the scissor",
  "Your paper is eaten by the lizard",
];
scissorsarray = [
  "Your scissors cuts the paper",
  "Your scissor is hit hard by the spock",
  "it's a tie",
  "Your scissor beheaded the lizard",
  "Your scissor is crushed by the rock",
];
lizardarray = [
...
function compare() {
  ...
  switch (playerpick) {
    case "rock":
      document.getElementById("winnermsg").innerText = rockarray[rand];
      break;
    case "paper":
      document.getElementById("winnermsg").innerText = paperarray[rand];
      break;
    case "scissors":
      document.getElementById("winnermsg").innerText = scissorsarray[rand];
      break;
    case "lizard":
      document.getElementById("winnermsg").innerText = lizardarray[rand];
      break;
    case "spock":
      document.getElementById("winnermsg").innerText = spockarray[rand];
      break;
  }
}
=======
